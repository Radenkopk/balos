...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Obrisani blogovi</li>
        </ol>
    </nav>
    <div class="content">
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($allDeleted as $data)
                                    <tr>
                                        ...
                                        <td>{{$data->title}}</td>
                                        <td>
                                            <a href="/admin/blog/{{$data->id}}/destination" class="btn btn-warning">
                                                <i class="fas fa-plane"></i> DESTINACIJA
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="pull-right">
                                                <a  type="button" href="/admin/blog/{{$data->id}}/edit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> IZMENI</a>
