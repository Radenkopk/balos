...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/regions">blog</a></li>
            <li class="breadcrumb-item"><a href="/admin/regions">destination</a></li>
            <li class="breadcrumb-item active" aria-current="page">Obrisane destinacije</li>
        </ol>
    </nav>
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h4 class="title">OBRISANE BlOGOVI</h4>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="pull-right">
                                                <a  type="button" href="/admin/blog/{{$blog_id}}/destination/{{$data->id}}/edit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> IZMENI</a>
                                                <form class="d-inline" method="POST" action="/admin/blog/{{$blog_id}}/destination/{{$data->id}}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
