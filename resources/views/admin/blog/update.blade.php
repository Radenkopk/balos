...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Izmenite blog</li>
        </ol>
    </nav>
    {!! Form::model($data, ['route' => ['blog.update', $data->id], 'method' => 'PUT', 'class' => 'input-admin']) !!}
        {{ csrf_field() }}
    ...
    <div class="checkbox">
        <label><input name="home" type="checkbox" value="1" @if($data->home == 1) checked @endif>Nalovna strana</label>
    </div>
    <div class="form-group">
        <label for="slug">SLUG</label>
        <input name="slug" type="text" class="form-control" id="slug" placeholder="unseite slug">
    </div>
        <div class="checkbox">
