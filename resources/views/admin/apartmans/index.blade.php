...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="/admin/apartmans" method="get">
                    ...
                    <div class="card">
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($allData as $data)
                                    <tr class="counter">
                                        ...
                                        <td>{{$data->title}}</td>
                                        <td>
                                            <a href="/admin/apartmans/{{$data->id}}/images-apartmans" class="btn btn-warning">
                                        ...
                                        <td>
                                            <div class="pull-right">
                                                <a  type="button" href="/admin/apartmans/{{$data->id}}/edit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> IZMENI</a>
                                                <form class="d-inline" method="POST" action="/admin/apartmans/{{$data->id}}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <button type="submit" class="btn btn-danger btn-delete-aparman"><i class="fas fa-trash-alt"></i> OBRIŠI</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="btn-add">
                        <a class="btn btn-success pull-right btn-lg" href="/admin/apartmans/create" role="button">
                            <i class="fas fa-plus-circle"></i> DODAJTE NOVI APARTMAN
                        </a>
                        </div>
                    </div>
                    <a class="btn btn-danger btn-lg" href="/admin/apartmans/deleted" role="button">
                        <i class="fas fa-trash-alt"></i>  OBRISANI APARTMANI
                    </a>
                </div>
            </div>
        </div>
