...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/regions">Regije</a></li>
            <li class="breadcrumb-item active" aria-current="page">Obrisane regije</li>
        </ol>
    </nav>
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h4 class="title">OBRISANE REGIJE</h4>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="pull-right">
                                                <a  type="button" href="/admin/regions/{{$data->id}}/edit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> IZMENI</a>
